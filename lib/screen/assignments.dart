...
import 'package:canvas_connect/screen/assignment_details.dart';
...
class Assignments extends StatelessWidget {
  ...
  Widget _buildAssignmentCard(
    ...
    return InkWell(
      onTap: (){
        Navigator.of(context).push(MaterialPageRoute(builder: (contex)=>AssignmentDetail(courseId: course.id, assignmentId: assignmentId)));
      },
      child: Container(
